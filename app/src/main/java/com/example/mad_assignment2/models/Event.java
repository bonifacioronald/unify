...
public class Event {
    ...
    public Event(String title, String description, String organizer, String backgroundLogoUrl, Date startDate, Date endDate, String time, ArrayList<String> vendorIdList) {
        this.title = title;
