...
public class EventInitData {
    ...
    public static ArrayList<Event> initializeEventToArrayList() throws Exception {
        ...
        Event cnsFestival = new Event("1",
                ...
                new Date(String.valueOf(dateFormat.parse("20-11-2023"))),
                new Date(String.valueOf(dateFormat.parse("25-11-2023"))),
                "8:00 AM - 5:00 PM",
        ...
        Event traditionalFoodFestival = new Event("2",
                ...
                new Date(String.valueOf(dateFormat.parse("27-11-2023"))),
                new Date(String.valueOf(dateFormat.parse("30-11-2023"))),
                "8:00 AM - 5:00 PM",
                new ArrayList<>());
