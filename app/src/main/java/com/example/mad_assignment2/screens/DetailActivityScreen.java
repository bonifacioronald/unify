...
public class DetailActivityScreen extends AppCompatActivity {
    ...
    private void setDetailContent(int buttonId) {
        ...
        if (vendor != null) {
            // Set vendor details
            imageView1.setImageResource(getResources().getIdentifier(vendor.getBoothDirectory(), "drawable", getPackageName()));
            imageView2.setImageResource(getResources().getIdentifier(vendor.getBoothDirectory(), "drawable", getPackageName()));
